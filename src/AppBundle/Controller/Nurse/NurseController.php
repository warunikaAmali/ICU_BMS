...
//                    'format' => 'YYYY-MM-dd  HH:mm'))
        ...
        if($form->isValid()){
            ...
            $query = "INSERT INTO condition (BHT_No, acuteRenalFailure, confirmedInfection, vasoactiveMedication, invasiveMedication,
                            nonInvaisveMedication, dialysis, dialysisType,heartRate, pulseRate, bodyTemperature, paralysed,spontaneousBreathing, bloodPressure, hydrogenState) VALUES ";
            $query .= "(" . $condition->getBhtNo() .  ", ";
            $query .= "'"  . $condition->getAcuterenalfailure() . "', '" . $condition->getConfirmedinfection() . "', ";
